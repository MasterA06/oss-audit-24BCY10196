...
- The manifesto file generated by Script 5 will be named after your current Linux username (e.g., `manifesto.txt`).
- Script files are saved and contain the logic described in the `.sh` starter templates from the project brief.
